...
public class candidature {
    ...
    public candidature(int id_pub, String contenue) {
        this.id_pub = id_pub;
    ...
    public candidature( String contenue,int idcom) {
        this.id = idcom;
        this.contenue = contenue;
    }
    

    public candidature(String contenue) {
        this.contenue = contenue;
    }
    ...
    public candidature(int id, int id_utilisateurn, int id_pub, String contenue, String created_at) {
        this.id = id;
        this.id_utilisateurn = id_utilisateurn;
        this.id_pub = id_pub;
        this.contenue = contenue;
